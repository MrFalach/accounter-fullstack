            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  ...
                  <td className="px-4 py-3 text-sm text-gray-900">Main Account</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{charge.description}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">REF-{charge.id}</td>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  ...
                  <td className="px-4 py-3 text-sm text-gray-900">Invoice</td>
                  <td className="px-4 py-3 text-sm text-gray-900">INV-{charge.id}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{charge.description}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{charge.counterparty}</td>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-4 py-3 text-sm text-gray-900">{charge.date}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{charge.date}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">Expense Account</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{charge.amount}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">Accounts Payable</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{charge.amount}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{charge.description}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">REF-{charge.id}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">
